  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <h1 className="text-3xl md:text-4xl font-display font-bold text-foreground mb-8">{t(translations.legal.privacyTitle)}</h1>
        <p className="text-sm text-muted-foreground mb-8">{t(translations.legal.lastUpdated)}</p>

        <div className="prose prose-sm max-w-none space-y-6 text-foreground/80">
          {translations.legal.privacySections.map((section, i) => (
            <section key={i}>
